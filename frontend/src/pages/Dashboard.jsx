  ...
  return (
    <div className="flex flex-col h-full overflow-y-auto pr-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="bg-slate-800 p-6 rounded-2xl border border-slate-700 flex items-center gap-4">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="bg-slate-800 p-6 rounded-2xl border border-slate-700 flex items-center gap-4">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="bg-slate-800 p-6 rounded-2xl border border-slate-700 flex items-center gap-4">
      ...
      <div>
        ...
        {history.length === 0 ? (
          <div className="bg-slate-800 rounded-2xl border border-slate-700 p-8 text-center flex flex-col items-center">
            ...
            <Link to="/debug" className="mt-4 bg-indigo-600 hover:bg-indigo-500 px-5 py-2 rounded-xl text-sm font-semibold transition">
              Start Debugging
            </Link>
          </div>
        ) : (
          <div className="bg-slate-800 rounded-2xl border border-slate-700 overflow-hidden">
            {history.slice(0, 5).map((record, index) => (
              <div key={record._id} className={`p-4 flex items-center justify-between ${index !== 0 ? 'border-t border-slate-700' : ''}`}>
