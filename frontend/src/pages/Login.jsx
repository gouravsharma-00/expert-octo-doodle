    ...
    <div className="bg-[#0b1120] min-h-screen flex items-center justify-center p-6 text-white font-sans">
      ...
      >
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4">
          ...
          <button type="submit" className="mt-4 bg-indigo-600 hover:bg-indigo-500 transition px-5 py-3 rounded-xl font-semibold shadow-lg shadow-indigo-600/20">
            Sign In
          </button>
        </form>
        
        <p className="mt-6 text-center text-slate-400 text-sm">
          Don't have an account? <Link to="/register" className="text-indigo-400 hover:text-indigo-300 font-semibold">Register</Link>
        </p>
      </motion.div>
    </div>
  );
